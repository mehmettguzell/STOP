...
import { EditMatchScreenProps } from '../../navigation/types';
...
export default function EditMatchScreen({ route, navigation }: EditMatchScreenProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Güncellendi', 'Maç başarıyla kaydedildi.', [
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <Text style={styles.pageTitle}>Maçı Düzenle</Text>
        ...
        <View style={styles.actions}>
          <Button title="Kaydet" onPress={handleSave} loading={saving} icon="✅" />
